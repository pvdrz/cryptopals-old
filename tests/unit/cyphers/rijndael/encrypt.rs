...
use cryptopals::cyphers::rijndael::encrypt::encrypt;
...
fn encrypt_0() {
    let b16 = Base16::new();
    let buf = b16.decode(b"00000000000000000000000000000000");
    let key = b16.decode(b"00000000000000000000000000000000");
    let out = b16.decode(b"66e94bd4ef8a2c3b884cfa59ca342b2e");
    assert_eq!(encrypt(&buf, &key), out);
}
